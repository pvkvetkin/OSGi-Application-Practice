...
public class NewsServiceImplementation implements NewsService {
    ...
    /**
     * Loads certain feed, which should be in system property ("URL_NEWS")
     */
    @Override
    public void loadFeed() {
        try {
            ...
            throw new RuntimeException("URL cannot be open", e);
//            throw new RuntimeException("An input/output error has occurred", e);
        } catch (FeedException e) {
            throw new RuntimeException("Feed cannot be read", e);
        }
    }
